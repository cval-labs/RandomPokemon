...
**Random Pokemon** is an android app that displays a random Pokemon from the PokeAPI.
...
Through this project, I learned to examine and parse a JSON response, as well as parse and display multiple fields from an API.
